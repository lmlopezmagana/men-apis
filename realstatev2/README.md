...
Un API RESTful generada con [generator-rest](https://github.com/diegohaz/generator-rest).

Puedes ver la documentación de la API en [documentation](DOCS.md).

## Comandos

Tras generar el proyecto, los comandos disponibles en `package.json` son:
